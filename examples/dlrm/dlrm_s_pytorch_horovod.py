...
if __name__ == "__main__":
    ...
    optimizer = hvd.DistributedOptimizer(optimizer, named_parameters=dlrm.named_parameters(),op=hvd.Average)
    ...
    with torch.autograd.profiler.profile(args.enable_profiling, use_gpu) as prof:
        while k < args.nepochs:
            ...
            for j, (X, lS_o, lS_i, T) in enumerate(train_ld):
                ...
                '''
                time_2=time.time()
                print(F"before forward:{time_2-time_1}")
                # forward pass
                #Z = dlrm_wrap(X, lS_o, lS_i, use_gpu, device)
                Z = dlrm(X, lS_o, lS_i)
                time_3=time.time()
                print(F"forward time:{time_3-time_2}")
                ...
                time_4=time.time()
                print(F"Compute loss time:{time_4-time_3}")
                if not args.inference_only:
                    ...
                    optimizer.zero_grad()
                    time_4_2=time.time()
                    print(F"optimizer zero grad time:{time_4_2-time_4_1}")
                    # backward pass
                    E.backward()
                    time_4_3=time.time()
                    print(F"optimizer backward time:{time_4_3-time_4_2}")                    
                    ...
                    optimizer.step()
                    time_4_4=time.time()
                    print(F"optimizer step time:{time_4_4-time_4_3}")                    
                    lr_scheduler.step()
                    time_4_5=time.time()
                    print(F"learning rate step time:{time_4_5-time_4_4}")
                ...
                total_iter += 1
                total_samp += mbs
                #print(F"training iter{total_iter}")
                time_5=time.time()
                print(F"after loss time:{time_5-time_4}")
                ...
                if should_print or should_test:
                    ...
                    total_samp = 0
                time_6=time.time()
                print(F"print output time:{time_6-time_5}")
                # testing
                if should_test and not args.inference_only:
                    ...
                    if (args.mlperf_logging
                        ...
                        break
                time_7=time.time()
                print(F"test time:{time_7-time_6}")
                print(F"training iter{total_iter},this iter consuming time:{time_7-time_1}")
            k += 1  # nepochs
