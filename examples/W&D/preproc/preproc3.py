...
#os.environ['PYSPARK_PYTHON'] = "/root/ht/ML/wdenv/wdenv/bin/python"
...
conf = SparkConf().setMaster('spark://sr112:7077').set('spark.executor.memory', '200g').set('spark.driver.memory', '200g')#.set("spark.archives", "/mnt/nvm6/pyspark_conda_env.tar.gz#wdenv")
...
if evaluation:
    ...
    # get training set number, used in training
