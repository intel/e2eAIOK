...
class DLRMTorch110Advisor(BaseModelAdvisor):
    '''
    ...
    def train_model(self, args):
        ...
        file1 = open("/home/vmagent/app/hydro.ai/modelzoo/dlrm_torch1.10/dlrm/best_auc.txt",'r')
    ...
    def launch(self, args):
        ...
        cmd = f"{self.train_python} -u -m intel_extension_for_pytorch.cpu.launch "
