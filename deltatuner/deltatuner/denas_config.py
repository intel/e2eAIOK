...
class DeNASConfig(object):
    ...
    budget_latency_max: int = field(default=None, metadata={"help": "The max latency limit of the candidate network"})
    budget_latency_min: int = field(default=0, metadata={"help": "The min latency limit of the candidate network"})
    tokenizer: AutoTokenizer = field(default=None, metadata={"help": "The tokenizer used in the de-nas"})
    ...
    search_space_name: list = field(default=None, metadata={"help": "The search space name of delta layers"})
