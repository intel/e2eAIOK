...
echo "test_llmutils.Test_LLMUtils.test_llm_pipeline"
python -m unittest tests.test_llmutils.Test_LLMUtils.test_llm_pipeline
if [ $? != 0 ]; then
    failed_tests=${failed_tests}"tests.test_llmutils.Test_LLMUtils.test_llm_pipeline\n"
fi
