...
from ai_matrix.cpu.script.model import *
from ai_matrix.cpu.script.utils import *
...
def build_model(model_type, n_uid, n_mid, n_cat, batch_size=128, maxlen=100, data_type='FP32'):
    if model_type == 'DNN':
