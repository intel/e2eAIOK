...
do
    ...
    # numactl -C 0-19,40-59 --localalloc python script/inference_pb.py         --mode=test         --batch_size=$batch         --pb_path=$pb      --num-inter-threads=20     2>&1 | tee /home2/yunfeima/logs/dien/multi-instance/1_-1_1024_notcmalloc_manual_g115.log 
