...
# train
## phrase1: prepare saving logits
cd /home/vmagent/app/e2eaiok/e2eAIOK/DeNas
sed -i '/train_epochs:/ s/:.*/: 1/' ../../conf/denas/nlp/e2eaiok_workflow_train_bert.conf
sed -i '/is_saving_logits:/ s/:.*/: True/' ../../conf/denas/nlp/e2eaiok_workflow_train_bert.conf
python -m intel_extension_for_pytorch.cpu.launch --distributed --nproc_per_node=1 --nnodes=1 train.py --domain bert --conf /home/vmagent/app/e2eaiok/conf/denas/nlp/e2eaiok_workflow_train_bert.conf
## phrase2: prepare saving logits
cd /home/vmagent/app/e2eaiok/e2eAIOK/DeNas
