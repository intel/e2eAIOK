...
if __name__ == "__main__":
    ...
    ######## Save to csv
    t1 = time.time()
    test[['engaging_user_id', 'tweet_id', f"pred2_{label_names[0]}",f"pred2_{label_names[1]}",f"pred2_{label_names[2]}",f"pred2_{label_names[3]}"]].to_csv(f"{pred_save_path}/xgboost_inference_{distributed_node_index}.csv",index=0)
