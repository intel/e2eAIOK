...
def calculate(sess, test_data, input_tensor, output_tensor):
    ...
    for i in range(1, nums + 1):
        ...
        # if i == 700:
            ...
            with open('./timeline/dien_1core_1inst_timeline_g115_skx6248_fp32_step{}_0515_newset_pb_2.json'.format(i), 'w') as f:
...
def inference(pb_path,      
    ...
    with tf.compat.v1.Session(graph=graph, config=session_config) as sess:
        ...
        for i in range(niters):
            test_auc, test_accuracy, eval_time, num_iters = calculate(sess, test_data, input_tensor, output_tensor)
