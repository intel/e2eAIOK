...
def parse_args():
    ...
    parser.add_argument('--dataset_format', type=str, default='Binary', help='Train/test dataset format')
...
if __name__ == '__main__':
    ...
    sda = SDA(sda_args.model, sda_args.dataset_format, sda_args.dataset_meta_path, sda_args.train_path, sda_args.eval_path, model_args)
    sda.launch()