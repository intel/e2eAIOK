...
python -m intel_extension_for_pytorch.cpu.launch --distributed --nproc_per_node=2 --nnodes=1 ./trainer/train.py --domain bert --conf /home/vmagent/app/e2eaiok/conf/denas/nlp/e2eaiok_denas_train_bert.conf --do_lower_case 2>&1 | tee BERT_distributed_training_${RANDOM_SEED}.log
